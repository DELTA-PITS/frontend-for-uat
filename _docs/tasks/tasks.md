...
| 22 | Perbaiki konfigurasi Keycloak: `http://localhost:3000/api/auth/logout` belum terdaftar di "Valid Post Logout Redirect URIs" client — logout gagal dengan error "Invalid redirect uri". **Butuh akses Keycloak admin console**, di luar kendali sesi coding | Security/Infra | High (blocker fungsional logout) | Audit sesi login 2026-08-02 |
